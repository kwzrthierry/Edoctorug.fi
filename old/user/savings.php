...
$sql = "SELECT * FROM savings WHERE id_number = ?";
...
// Initialize an empty array to store savings
$savings = [];
    ...
    <div id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                    ...
                    <form method="GET" action="savings.php">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4 align-self-end">
                                ...
                                <a href="savings.php" class="btn btn-secondary">Clear</a>
                            </div>
                        </div>
                    </form>
                </div>
                        ...
                        <tbody>
                            <?php if (count($savings) > 0): ?>
                                <?php foreach ($savings as $saving): ?>
                                    <tr>
                                        <td><?php echo htmlspecialchars($saving['savings_id']); ?></td>
                                        <td><?php echo htmlspecialchars($saving['date']); ?></td>
                                        <td><?php echo htmlspecialchars($saving['amount']); ?></td>
                                        <td><?php echo htmlspecialchars($saving['total_current_amount']); ?></td>
                                    </tr>
                                <?php endforeach; ?>
                            <?php else: ?>
                                <tr>
                ...
                $countSql = "SELECT COUNT(*) AS total FROM savings WHERE id_number = ?";
                if ($startDate && $endDate) {
                ...
                if ($startDate && $endDate) {
                    $countStmt->bind_param("sss", $userNationalId, $startDate, $endDate);
                } else {
                    $countStmt->bind_param("s", $userNationalId);
                }
